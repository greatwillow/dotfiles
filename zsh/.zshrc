...
SHELLS_COMMON_CONFIG_DIRECTORY="$BASE_CONFIG_DIRECTORY/_common"
SHELL_ALIASES_DIRECTORY="$SHELLS_COMMON_CONFIG_DIRECTORY/posix_aliases"
SHELL_EXPORTS_DIRECTORY="$SHELLS_COMMON_CONFIG_DIRECTORY/posix_exports"
